...
function food(partial: Omit<Food, 'source' | 'verified' | 'createdAt' | 'updatedAt'>): Food {
  return { ...partial, source: 'healthyme_calculated', verified: true, createdAt: now, updatedAt: now };
}
...
export const FOOD_DATABASE_SEED: Food[] = [
  ...
  food({ id: 'food_protein_shake', name: 'Whey Protein Shake', brand: 'HealthyMe Nutrition', category: 'Supplements', barcode: '4006381333931', servingSize: 30, unit: 'g', calories: 120, protein: 24, carbohydrates: 3, fat: 1.5 }),
  food({ id: 'food_oat_milk', name: 'Oat Milk', brand: 'HealthyMe Nutrition', category: 'Dairy Alternatives', barcode: '7350031320013', servingSize: 100, unit: 'ml', calories: 47, protein: 1, carbohydrates: 6.7, fat: 1.5 }),
];
