...
/** Gates `Main` in RootNavigator — a non-empty address (collected on AddressStepScreen, right after registration) is required before the app is considered fully set up, per the HealthyMe webshop's needs. */
